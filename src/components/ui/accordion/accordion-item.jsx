...
// Компонент AccordionItem должен обрабатывать все props.
// Если будет установлен флаг open, то нужно через ref
// вычислять высоту контента и выставлять её
// в качестве высоты элемента, чтобы раскрыть аккордеон
// на этом элементе.
// Если open = false, скроем элемент, выставив высоту в 0:
